...
const (
	...
	GetBlockedUsersRoute      = "/blocked-users"
	...
	InventoryAlertsRoute      = "/admin/low-stock"
	ShippingMethodsRoute      = "/shipping/methods"
	AddShippingMethodRoute    = "/admin/shipping/method"
	BulkStockUpdateRoute      = "/admin/stock/bulk-update"
	GetUserNotificationsRoute = "/notifications"
	MarkNotificationReadRoute = "/notifications/:id/read"
	DeleteNotificationRoute   = "/notifications/:id"
)
